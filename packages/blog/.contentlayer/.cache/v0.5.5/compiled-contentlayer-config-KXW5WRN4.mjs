...
var require_siteMetadata = __commonJS({
  "data/siteMetadata.js"(exports, module) {
    var siteMetadata2 = {
      ...
      author: "vektr",
      headerTitle: "Home",
      description: "AI-curated cryptocurrency news and analysis from trusted sources across the web. Stay updated with Bitcoin, Ethereum, DeFi, and the latest crypto market trends.",
      language: "en-us",
      theme: "system",
      // system, dark or light
      siteUrl: "https://vektr.news",
      siteRepo: "https://github.com/yourusername/vektr",
      siteLogo: `${process.env.BASE_PATH || ""}/static/images/logo.png`,
      socialBanner: `${process.env.BASE_PATH || ""}/static/images/twitter-card.png`,
      mastodon: "https://mastodon.social/@vektr",
      email: "curator@vektr.news",
      github: "https://github.com/yourusername/vektr",
      x: "https://twitter.com/vektr",
...
//# sourceMappingURL=compiled-contentlayer-config-KXW5WRN4.mjs.map
